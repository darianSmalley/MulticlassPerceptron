...
public class MulticlassWeka {
    ...
    public static Evaluation classify(Classifier model, Instances dataSet) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Instantiate perceptron classifier with command arguments
        String[] options = new String[2];
        options[0] = args[0]; // input filename
